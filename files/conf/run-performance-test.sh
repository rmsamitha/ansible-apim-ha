...
ssh -i apim310.key $jmeter1 "./performance-common/distribution/scripts/jmeter/jmeter-server-start.sh -n server1.apim.com -i /home/ubuntu/"
ssh -i apim310.key $jmeter2 "./performance-common/distribution/scripts/jmeter/jmeter-server-start.sh -n server2.apim.com -i /home/ubuntu/"
